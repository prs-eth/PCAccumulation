...
from libs.utils import load_pkl, natural_key, to_o3d_pcd, multi_vis
import numpy as np
...
if __name__=='__main__':
    ...
    for seq_id in range(20):
        ...
        for idx, lidar in enumerate(lidar_path):
            ...
            is_not_ground = get_non_ground(points)
            ...
            is_not_ground = points[:,2] > ground_height+0.3
